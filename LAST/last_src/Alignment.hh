...
*/
			...
			/*
			void write( const MultiSequence& database,
			...
			std::string getIdentityString( const MultiSequence& database,
			                               const MultiSequence& queries,
			                               char strand, bool isTranslated,
			                               const Alphabet& alph) const ;
			*/

			void writeIdentity( const MultiSequence& database,
			                    const MultiSequence& queries,
			                    char strand,
			                    bool isTranslated,
			                    const Alphabet& alph,
			...
			char* writeRepresentative( const uchar* reference,
			                           const Alphabet& alph,
			                           indexT frameSize,
			                           char* reference_buffer) const ;

			char* writeMember( const uchar* seq,
			                   const Alphabet& alph,
			                   indexT frameSize,
			                   char* dest ) const ;
